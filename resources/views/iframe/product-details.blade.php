...
<div class="container">
    <div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
        <button class="how-pos3 hov3 trans-04 js-hide-modal1">
            <img src="{{url('storage/images/icons/icon-close.png')}}" alt="CLOSE">
        </button>
                        ...
                        <div class="slick3 gallery-lb">
                            <div class="item-slick3" data-thumb="{{asset('storage/images/product-detail-01.jpg')}}">
                                <div class="wrap-pic-w pos-relative">
                                    <img src="{{url('storage/images/product-detail-01.jpg')}}" alt="IMG-PRODUCT">
                            ...
                            <div class="item-slick3" data-thumb="{{asset('storage/images/product-detail-02.jpg')}}">
                                <div class="wrap-pic-w pos-relative">
                                    <img src="{{url('storage/images/product-detail-02.jpg')}}" alt="IMG-PRODUCT">
